# Overall 
This is my AI: *joppa*. Feel free to use this as a template for your own AI. Made by me with python
version: joppa 0.1t
...
+ ——————————————————————————————————————————————————————————————————————————————————————————————— +
| b ⚖️ | balanced | a balanced model (base model)                                                 |
